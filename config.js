...
module.exports = {
  ...
  BOT_NAME: process.env.BOT_NAME || '★ σвιтσ-кυη ★',
  ...
  BOT_INFO: process.env.BOT_INFO || '★ σвιтσ-кυη ★;★ σвιтσ-кυη ★;918101821810;https://files.catbox.moe/k6fdqo.jpeg',
  AUDIO_DATA: process.env.AUDIO_DATA || '★ σвιтσ-кυη ★;★ σвιтσ-кυη ★;https://files.catbox.moe/k6fdqo.jpeg',
  STICKER_DATA: process.env.STICKER_DATA || '★ σвιтσ-кυη ★;🇮🇳🍁',
